...
<!-- Optional header components (ex: slider) -->
  ...
  <!-- MAIN CONTENT -->
  <div id="content">
       <div class=" e-block-centered e-block-skin hp-services style_reg" data-stellar-background-ratio="0.5">
             <div class="container">
              <div class="row">
                <!-- CONTENT -->
                <?php if ($column_left) { ?>
              ...
              <div class="form-group">
                <div class="col-xs-offset-3 col-xs-6 col-sm-4 col-sm-offset-4">
                  <div class="pull-right"><?php echo $text_agree; ?>
                    ...
                    <?php } ?>
                    &nbsp;
                    <input type="submit" value="<?php echo $button_continue; ?>" class="btn  btn-lg btn-block  btn-gr bnt_more_sq" />
                  </div>
                </div>
              </div>
              <?php } else { ?>
